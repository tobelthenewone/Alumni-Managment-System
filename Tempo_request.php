...
if (isset($_POST["submit"])) {
  ...
  ";
      ...
      $query = "INSERT INTO tempo_request VALUES('', '$name', '$gender', '$id_number', '$program_type', '$phone_number', '$graduation_date', '$department', '$newImageName', '$email')";
  ...
  <div class="container-fluid h-100">
    <div class="row h-100 align-items-center justify-content-center text-center">
      <div class="col-lg-8 align-self-end mb-4 page-title">
        <h3 style="font-size: 30px;" class="text-blue">Temporary Degree Request Form</h3>
    ...
    <form method="POST" class="row" autocomplete="off" enctype="multipart/form-data">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="fullName" class="form-control" required id="fullName" pattern="[a-zA-Z\s]*"
        ...
        <div class="form-group">
          ...
          <div class="d-flex align-items-center">
            <div class="form-check mr-4">
              <input class="form-check-input" type="radio" name="gender" required value="male" id="male">
              <label class="form-check-label" for="male">
                Male
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="gender" required value="female" id="female">
        ...
        <div class="form-group">
          ...
          <input type="text" required name="id_number" class="form-control" id="" placeholder="Enter ID number">
        </div>
        <div class="form-group">
          <label for="email" class="font-weight-bold">Email</label>
          <input type="email" required name="email" class="form-control" id="" placeholder="Enter Email number">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="phone_number" required class="form-control" id="" placeholder="Enter Phone Number">
        </div>
        <div class="form-group">
          <label for="document" class="font-weight-bold">Service Fee payment Reciept</label>
