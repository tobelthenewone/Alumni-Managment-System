...
if (isset($_GET['id'])) {
	$qry = $conn->query("SELECT * FROM tempo_request where id=" . $_GET['id'])->fetch_array();
	foreach ($qry as $k => $v) {
		$$k = $v;
	}
}
...
<div class="container-fluid">
	...
	<p>Phone Number: <b>
			<large><?php echo ucwords($phone_number) ?></large>
		</b></p>
	<p>Department: <b>
	...
	<p>Service Fee: <b>
			<large>
				<div class="image-container">
					<img src="img/<?php echo $qry["image"]; ?>" class="image" title="<?php echo $qry['image']; ?>">
					<div class="fullscreen-overlay">
						<img src="img/<?php echo $qry["image"]; ?>" class="fullscreen-image"
							title="<?php echo $qry['image']; ?>">
					</div>
				</div>
			</large>
		</b></p>
