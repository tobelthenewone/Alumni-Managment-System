...
if (isset($_GET['id'])) {
    $qry = $conn->query("SELECT * FROM original_degree where id=" . $_GET['id'])->fetch_array();
    foreach ($qry as $k => $v) {
        $$k = $v;
    }
}
...
<div class="container-fluid">
    ...
    <p>Gender: <b>
            <large><?php echo ucwords($gender) ?></large>
        </b></p>
    <p>ID Number: <b>
            <large><?php echo ucwords($id_number) ?></large>
        </b></p>
    <p>Email: <b>
            <large><?php echo ucwords($email) ?></large>
        </b></p>
    <p>Program Type: <b>
    ...
    <p>Phone Number: <b>
            <large><?php echo ucwords($phone) ?></large>
        </b></p>
    <p>Cost Sharing Letter: <b>
            <large>
                <div class="image-container">
                    <img src="img/<?php echo $qry["service_fee"]; ?>" class="image"
                        title="<?php echo $qry['service_fee']; ?>">
                    <div class="fullscreen-overlay">
                        <img src="img/<?php echo $qry["service_fee"]; ?>" class="fullscreen-image"
                            title="<?php echo $qry['service_fee']; ?>">
                    </div>
                </div>
            </large>
