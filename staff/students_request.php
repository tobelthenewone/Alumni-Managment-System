							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-outline-danger delete_tempo" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_tempo').click(function(){
		_conf("Are you sure to delete this post?","delete_tempo",[$(this).attr('data-id')],'mid-large')
	})

	function delete_tempo($id){
		start_load()
		$.ajax({
			url:'ajax.php?action=delete_tempo',
			method:'POST',
			data:{id:$id},
