...
class Action
{
	...
	function delete_tempo()
	{
		extract($_POST);
		$delete = $this->db->query("DELETE FROM tempo_request where id = " . $id);
		if ($delete) {
			return 1;
		}
	}
	...
	{
		extract($_POST);
		$delete = $this->db->query("DELETE FROM transcript_form where id = " . $id);
		if ($delete) {
			return 1;
		}
	}
	...
	{
		extract($_POST);
		$delete = $this->db->query("DELETE FROM original_degree where id = " . $id);
		if ($delete) {
			return 1;
		}
	}
