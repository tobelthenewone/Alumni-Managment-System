...
<div class="container">
    <div class="card mb-4 mt-4 bg-black">
        <div class="card-body">
            <div class="row">
                <div class="col-md-8">
    ...
    <div class="row-items">
        <div class="col-lg-12">
            <div class="row">
                ...
                $alumni = $conn->query("SELECT a.*,c.course,Concat(a.firstname,' ',a.lastname) as name from alumnus_bio a inner join courses c on c.id = a.course_id order by Concat(a.lastname,', ',a.firstname) asc");
                while ($row = $alumni->fetch_assoc()):
                    ?>
                    <div data-aos="fade-up" class="col-md-4 item">
                        <div class="card alumni-list bg-black" data-id="<?php echo $row['id'] ?>">
